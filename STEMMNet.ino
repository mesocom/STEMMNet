...
#define SN_ID "SN000001"
#define API_KEY "6nmSBMrg1NbOzJucphcL"
#define LOG_TIME 1800
#define UPLOAD_TIME 3600

// Temperature sensor addresses - in order of 0->4
DeviceAddress dsAddresses[5] = {
{0x28, 0xBA, 0x81, 0x1F, 0xF, 0x0, 0x0, 0x2D},
{0x28, 0x94, 0xC, 0x21, 0xF, 0x0, 0x0, 0xF2},
{0x28, 0xC2, 0x98, 0xD, 0xF, 0x0, 0x0, 0xA4},
{0x00, 0x00, 0x00, 0x0, 0x0, 0x0, 0x0, 0x0},
{0x00, 0x00, 0x00, 0x0, 0x0, 0x0, 0x0, 0x0}
};
...
bool cellRadioSetup() {
  ...
  assetTracker.setHTTPserverPort(0, 1000);
